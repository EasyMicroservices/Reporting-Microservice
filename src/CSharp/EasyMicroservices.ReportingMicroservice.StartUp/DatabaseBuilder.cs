using EasyMicroservices.ReportingMicroservice.Database;
...
namespace EasyMicroservices.ReportingMicroservice
{
    public class DatabaseBuilder : IEntityFrameworkCoreDatabaseBuilder
    {
        ...
        {
            optionsBuilder.UseInMemoryDatabase("ReportingDatabase");
