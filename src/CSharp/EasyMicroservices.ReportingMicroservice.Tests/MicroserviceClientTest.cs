...
namespace EasyMicroservices.ReportingMicroservice.Clients.Tests
{
...
{""result"":[],""isSuccess"":true,""error"":null}");
        ...
        {
            //await OnInitialize();
            //var microserviceClient = new Reporting.GeneratedServices.MicroserviceClient(_routeAddress, HttpClient);
